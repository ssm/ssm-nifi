...
describe 'nifi::config' do
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      it { is_expected.to contain_ini_setting('nifi property nifi.flowfile.repository.directory')
      ...
      # Explicit property
      it { is_expected.to contain_ini_setting('nifi property test.foo.bar')
                            .with_path('/opt/nifi/nifi-1.2.3/conf/nifi.properties')
