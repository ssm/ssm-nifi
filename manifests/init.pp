...
class nifi (
  ...
  String $download_url = 'http://mirrors.ibiblio.org/apache/nifi/1.14.0/nifi-1.14.0-bin.tar.gz',
  String $download_checksum = '858e12bce1da9bef24edbff8d3369f466dd0c48a4f9892d4eb3478f896f3e68b',
